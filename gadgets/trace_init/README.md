...
The trace_init gadget emits events when processes invoke the `init_module(module_image, len, param_values)` syscall to load kernel modules.
...
Check the full documentation on https://inspektor-gadget.io/docs/latest/gadgets/trace_init
