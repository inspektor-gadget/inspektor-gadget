...
#define GADGET_MAPITER(name, hist_name, hist_key_type) \
	const void *gadget_mapiter_##name##___##hist_name##___##hist_key_type##___hist_value __attribute__((unused)); \
...
GADGET_MAPITER(blockio, hists, hist_key);
