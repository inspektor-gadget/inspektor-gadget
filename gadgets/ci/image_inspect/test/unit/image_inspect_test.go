...
consume_skb -- "Lookup+Update" --> map1
consume_skb["consume_skb"]
kfree_skb -- "Lookup+Delete" --> map2
kfree_skb -- "Lookup+Update" --> map1
kfree_skb["kfree_skb"]
qdisc_dequeue -- "Lookup+Delete" --> map2
...
consume_skb->>map1: Lookup
consume_skb->>map1: Update
consume_skb->>map2: Delete
kfree_skb->>map2: Lookup
kfree_skb->>map1: Lookup
kfree_skb->>map1: Update
kfree_skb->>map2: Delete
qdisc_dequeue->>map2: Lookup
qdisc_dequeue->>map1: Lookup
qdisc_dequeue->>map1: Update
qdisc_dequeue->>map2: Delete
