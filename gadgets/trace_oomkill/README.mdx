...
<Tabs groupId="env">
    <TabItem value="kubectl-gadget" label="kubectl gadget">
        ...
        K8S.NODE           K8S.NAMESPACE             K8S.PODNAME               K8S.CONTAINERNAME         MNTNS_ID      FPID          FUID          FGID          TPID          PAGES        FCOMM        TCOMM        TIMESTAMP
        ```
        ...
        ```bash
        K8S.NODE           K8S.NAMESPACE             K8S.PODNAME               K8S.CONTAINERNAME         MNTNS_ID      FPID          FUID          FGID          TPID          PAGES        FCOMM        TCOMM        TIMESTAMP
        minikube-docker    oomkill-demo              oomkill-demo…dbf85d-r9tls busybox                   4026533320    728870        0             0             728870        4227071      tail         tail         2024-08-01T22:36:19.5001276…
        ```
    </TabItem>
    ...
    <TabItem value="ig" label="ig">
        ...
        RUNTIME.CONTAINERNAME               MNTNS_ID            FPID                FUID                FGID                TPID                PAGES              FCOMM              TCOMM              TIMESTAMP
        ```
        ...
        ```bash
        RUNTIME.CONTAINERNAME               MNTNS_ID            FPID                FUID                FGID                TPID                PAGES              FCOMM              TCOMM              TIMESTAMP
        test-trace-oomkill                  4026532205          733494              0                   0                   733494              262144             tail               tail               2024-08-02T00:41:03.306765837+02:00
        ```
    </TabItem>
</Tabs>
