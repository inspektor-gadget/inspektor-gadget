...
<Tabs groupId="env">
    <TabItem value="kubectl-gadget" label="kubectl gadget">
        ...
        K8S.NAMESPACE            K8S.PODNAME              K8S.CONTAINERNAME        SRC                              DST                              COMM                    PID           TID STATE         REASON        TCPFLAGS     TYPE    K8S.NODE     TIMESTAMP
        ```
        ...
        ```
        K8S.NAMESPACE            K8S.PODNAME              K8S.CONTAINERNAME        SRC                              DST                              COMM                    PID           TID STATE         REASON        TCPFLAGS     TYPE    K8S.NODE     TIMESTAMP
        default                  shell                    shell                    10.244.0.40:45638                10.98.34.183:80                  curl                 874866        874866 2             0             SYN          RETRANS minikube-do… 2024-08-02T10:51:08.918253…
        ```
