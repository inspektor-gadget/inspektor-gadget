...
type testDef struct {
	...
	generateEvent  func(t *testing.T) (int, generatedPaths, error)
		...
		t.Run(name, func(t *testing.T) {
			...
			onGadgetRun := func(gadgetCtx operators.GadgetContext) error {
				utils.RunWithRunner(t, runner, func() error {
					var err error
					fd, generated, err = testCase.generateEvent(t)
					if err != nil {
						return err
					}
					return nil
			...
			testCase.validateEvent(t, runner.Info, fd, generated, gadgetRunner.CapturedEvents)
		})
	}
}

// generateHardlinkEvent creates a hard link and cleans up afterwards.
func generateHardlinkEvent(t *testing.T) (int, generatedPaths, error) {
	base := t.TempDir()
	...
	return 0, generatedPaths{target: oldpath, linkPath: newpath}, nil
}

// generateSymlinkEvent creates a symlink and cleans up afterwards.
func generateSymlinkEvent(t *testing.T) (int, generatedPaths, error) {
	base := t.TempDir()
	...
	return 0, generatedPaths{target: target, linkPath: newpath}, nil
}
