...
K8S.NAMESPACE         K8S.PODNAME           K8S.CONTAINERNAME     SRC                        DST                        STATE  K8S.NODE
default               test-snapshot-socket  test-snapshot-socket  :::80                      :::0                       10     minikube-…
default               test-snapshot-socket  test-snapshot-socket  0.0.0.0:80                 0.0.0.0:0                  10     minikube-…
^C
```
