...
<Tabs groupId="env">
    <TabItem value="kubectl-gadget" label="kubectl gadget">
        ...
        K8S.NAMESPACE               K8S.PODNAME                 K8S.CONTAINERNAME           COMM                      PID            TID           UID           GID NAME                       K8S.NODE      TIMESTAMP
        ```
        ...
        ```bash
        K8S.NAMESPACE               K8S.PODNAME                 K8S.CONTAINERNAME           COMM                      PID            TID           UID           GID NAME                       K8S.NODE      TIMESTAMP
        default                     ubuntu                      ubuntu                      wget                   693742         693742             0             0 wikimedia.org              minikube-doc… 2024-08-01T22:01:54.129330541Z
        default                     ubuntu                      ubuntu                      wget                   693742         693742             0             0 www.wikimedia.org          minikube-doc… 2024-08-01T22:01:54.234518638Z
        ```
    </TabItem>
