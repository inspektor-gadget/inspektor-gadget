...
<Tabs groupId="env">
    <TabItem value="kubectl-gadget" label="kubectl gadget">
        ...
        K8S.NODE          K8S.NAMESPACE               K8S.PODNAME                 K8S.CONTAINERNAME           COMM                      PID            TID           UID           GID NAME                       TIMESTAMP
        ```
        ...
        ```bash
        K8S.NODE          K8S.NAMESPACE               K8S.PODNAME                 K8S.CONTAINERNAME           COMM                      PID            TID           UID           GID NAME                       TIMESTAMP
        minikube-docker   default                     ubuntu                      ubuntu                      wget                   693742         693742             0             0 wikimedia.org              2024-08-01T22:01:54.129330541Z
        minikube-docker   default                     ubuntu                      ubuntu                      wget                   693742         693742             0             0 www.wikimedia.org          2024-08-01T22:01:54.234518638Z
        ```
    </TabItem>
    ...
    <TabItem value="ig" label="ig">
        ...
        RUNTIME.CONTAINERNAME                      COMM                                PID                    TID                    UID                   GID NAME                                      TIMESTAMP
        ```
        ...
        ```bash
        RUNTIME.CONTAINERNAME                      COMM                                PID                    TID                    UID                   GID NAME                                      TIMESTAMP
        test-trace-sni                             wget                             697854                 697854                      0                     0 example.com                               2024-08-02T00:06:05.941143989+02:00
        ```
    </TabItem>
</Tabs>
