...
`
	...
	buildCmd := fmt.Sprintf("echo %s | base64 -d > chroot.c && "+
		...
		"gcc -Wall -o /bin/mychroot2                        -fPIE -pie chroot.c && "+
		"gcc -Wall -o /bin/mychroot3                -static            chroot.c && "+
		"gcc -Wall -o /bin/mychroot4                -static -fPIE -pie chroot.c && "+
		"gcc -Wall -o /bin/mychroot5 -Wl,--build-id                    chroot.c && "+
		"gcc -Wall -o /bin/mychroot6 -Wl,--build-id         -fPIE -pie chroot.c && "+
		"gcc -Wall -o /bin/mychroot7 -Wl,--build-id -static            chroot.c && "+
