...
<Tabs groupId="env">
    <TabItem value="kubectl-gadget" label="kubectl gadget">
        ...
        K8S.NAMESPACE            K8S.PODNAME              K8S.CONTAINERNAME        COMM                    PID          TID          UID          GID CAPABLE AUDIT    CAP          K8S.NODE     SYSCALL         TIMESTAMP
        default                  set-priority             set-priority             nice                 169528       169528            0            0 false   1        CAP_SYS_NICE minikube-do… SYS_SETPRIORITY 2024-08-01T12:19:02.100348…
        default                  set-priority             set-priority             nice                 169594       169594            0            0 false   1        CAP_SYS_NICE minikube-do… SYS_SETPRIORITY 2024-08-01T12:19:07.102775…
        default                  set-priority             set-priority             nice                 169661       169661            0            0 false   1        CAP_SYS_NICE minikube-do… SYS_SETPRIORITY 2024-08-01T12:19:12.105665…
        default                  set-priority             set-priority             nice                 169736       169736            0            0 false   1        CAP_SYS_NICE minikube-do… SYS_SETPRIORITY 2024-08-01T12:19:17.107993…
        ^C
        ```
        ...
        * `CAPABLE`: whether the process has the capability or not
        ...
        K8S.NAMESPACE            K8S.PODNAME              K8S.CONTAINERNAME        COMM                    PID          TID          UID          GID CAPABLE AUDIT    CAP          K8S.NODE     SYSCALL         TIMESTAMP
        default                  set-priority-1           set-priority-1           nice                 225549       225549            0            0 true    1        CAP_SYS_NICE minikube-do… SYS_SETPRIORITY 2024-08-01T13:25:42.571989…
        default                  set-priority-1           set-priority-1           nice                 225615       225615            0            0 true    1        CAP_SYS_NICE minikube-do… SYS_SETPRIORITY 2024-08-01T13:25:47.575287…
        default                  set-priority-1           set-priority-1           nice                 225688       225688            0            0 true    1        CAP_SYS_NICE minikube-do… SYS_SETPRIORITY 2024-08-01T13:25:52.578731…
        ^C
        ```
