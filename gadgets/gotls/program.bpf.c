...
SEC("uprobe//media/psf/inspektor-gadget/demofetch/demofetch:crypto/tls.(*Conn).Write")
...
SEC("uprobe//media/psf/inspektor-gadget/demofetch/demofetch:crypto/tls.(*Conn).Read")
...
SEC("uretprobe//media/psf/inspektor-gadget/demofetch/demofetch:crypto/tls.(*Conn).Read")
