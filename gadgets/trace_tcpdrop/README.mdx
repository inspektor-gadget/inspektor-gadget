...
<Tabs groupId="env">
    <TabItem value="kubectl-gadget" label="kubectl gadget">
        ...
        K8S.NODE                 K8S.NAMESPACE                                  K8S.PODNAME                                    K8S.CONTAINERNAME                              SRC                                                  DST                                                  MOUNT_NS_ID               COMM                                   PID                      TID STATE                    TCPFLAGS                 REASON                   TIMESTAMP
        ```
        ...
        ```
        K8S.NODE                 K8S.NAMESPACE                                  K8S.PODNAME                                    K8S.CONTAINERNAME                              SRC                                                  DST                                                  MOUNT_NS_ID               COMM                                   PID                      TID STATE                    TCPFLAGS                 REASON                   TIMESTAMP
        minikube-docker          default                                        shell                                          shell                                          10.244.0.36:55632                                    10.100.29.149:80                                     4026533295                curl                                833154                   833154 tcp_established          PSH|ACK                  …_DROP_REASON_QDISC_DROP 2024-08-02T10:11:29.781781105Z
        minikube-docker          default                                        shell                                          shell                                          10.244.0.36:55632                                    10.100.29.149:80                                     4026533295                curl                                833154                   833154 tcp_established          PSH|ACK                  …_DROP_REASON_QDISC_DROP 2024-08-02T10:11:29.982283400Z
        minikube-docker          default                                        shell                                          shell                                          10.244.0.36:55632                                    10.100.29.149:80                                     4026533295                curl                                833154                   833154 tcp_established          PSH|ACK                  …_DROP_REASON_QDISC_DROP 2024-08-02T10:11:30.190270740Z
        ```
    ...
    <TabItem value="ig" label="ig">
        ...
        RUNTIME.CONTAINERNAME      SRC                                DST                                MOUNT_NS_ID    COMM                      PID            TID STATE         TCPFLAGS      REASON        TIMESTAMP
        ```
        ...
        ```
        RUNTIME.CONTAINERNAME                                                       SRC                                                  DST                                                  MOUNT_NS_ID                              COMM                                                  PID                                     TID STATE                                   TCPFLAGS                                REASON                                  TIMESTAMP
        test-trace-tcpdrop                                                          172.17.0.2:52508                                     1.1.1.1:80                                           4026533225                               wget                                               854278                                  854278 tcp_established                         ACK                                     SKB_DROP_REASON_QDISC_DROP              2024-08-02T12:35:20.188383289+02:00
        test-trace-tcpdrop                                                          172.17.0.2:37838                                     1.1.1.1:443                                          4026533225                               wget                                               854278                                  854278 tcp_established                         ACK                                     SKB_DROP_REASON_QDISC_DROP              2024-08-02T12:35:20.597218523+02:00
        test-trace-tcpdrop                                                          172.17.0.2:37838                                     1.1.1.1:443                                          4026533225                               wget                                               854278                                  854278 tcp_fin_wait1                           FIN|ACK                                 SKB_DROP_REASON_QDISC_DROP              2024-08-02T12:35:25.659670258+02:00
        ```
    </TabItem>
</Tabs>
