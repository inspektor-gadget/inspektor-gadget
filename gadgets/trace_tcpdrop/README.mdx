...
<Tabs groupId="env">
    <TabItem value="kubectl-gadget" label="kubectl gadget">
        ...
        K8S.NAMESPACE                                  K8S.PODNAME                                    K8S.CONTAINERNAME                              SRC                                                  DST                                                  MOUNT_NS_ID               COMM                                   PID                      TID STATE                    TCPFLAGS                 REASON                   K8S.NODE                 TIMESTAMP
        ```
        ...
        ```
        K8S.NAMESPACE                                  K8S.PODNAME                                    K8S.CONTAINERNAME                              SRC                                                  DST                                                  MOUNT_NS_ID               COMM                                   PID                      TID STATE                    TCPFLAGS                 REASON                   K8S.NODE                 TIMESTAMP
        default                                        shell                                          shell                                          10.244.0.36:55632                                    10.100.29.149:80                                     4026533295                curl                                833154                   833154 tcp_established          PSH|ACK                  …_DROP_REASON_QDISC_DROP minikube-docker          2024-08-02T10:11:29.781781105Z
        default                                        shell                                          shell                                          10.244.0.36:55632                                    10.100.29.149:80                                     4026533295                curl                                833154                   833154 tcp_established          PSH|ACK                  …_DROP_REASON_QDISC_DROP minikube-docker          2024-08-02T10:11:29.982283400Z
        default                                        shell                                          shell                                          10.244.0.36:55632                                    10.100.29.149:80                                     4026533295                curl                                833154                   833154 tcp_established          PSH|ACK                  …_DROP_REASON_QDISC_DROP minikube-docker          2024-08-02T10:11:30.190270740Z
        ```
