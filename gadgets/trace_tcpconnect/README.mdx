...
sequenceDiagram
    ...
    rect rgba(0, 0, 255, .1)
        Note right of inet_stream_connect: Save skb in kprobe.<br/>We need it in the kretprobe,<br/>but don't have access to it
    ...
    rect rgba(0, 0, 255, .1)
        Note right of inet_stream_connect: Gather all information in the kprobe<br/>and submit the event
