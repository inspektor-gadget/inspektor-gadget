...
func (r *GadgetRunner) RunGadget(
	...
	operatorParamCollection params.ParamsCollection,
	...
	err := r.operators.InitAll(operatorParamCollection)
	if err != nil {
		return fmt.Errorf("initializing operators: %w", err)
	}
	err = r.runtime.RunGadget(r, runtimeParams, operatorPerGadgetParamCollection, gadgetParams)
	if err != nil {
