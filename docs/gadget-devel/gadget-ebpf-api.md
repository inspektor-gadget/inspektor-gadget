...
### `gadget_should_discard`

```c
bool gadget_should_discard(gadget_mntns_id mntns_id, gadget_pid pid, gadget_tid tid,
...
### `gadget_should_discard_current`

```c
bool gadget_should_discard_current()
```
