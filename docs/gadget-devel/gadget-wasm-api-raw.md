...
- `flags` (u64): A set of flags used to modify the update behavior. Correct values are documented [here](https://github.com/cilium/ebpf/blob/061e86d8f5e9/map.go#L790-L801). The additional value GetFdFlag can be used to store the FD of the map handle given as `valueptr`.
