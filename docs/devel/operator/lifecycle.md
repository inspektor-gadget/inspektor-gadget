...
The PreStart() method is called before the gadget is started. The operator
should register data sources and subscribe to existing ones on this method.
...
TODO: Do we have any real usage of this one?
