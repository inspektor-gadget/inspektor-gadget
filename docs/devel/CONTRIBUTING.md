...
- To be able to cross build our different container image, you will also need [`qemu-user-static`](https://github.com/multiarch/qemu-user-static).
...
- gadget-core: Contains only CO-RE gadgets that are integrated with the gadget tracer manager
