...
```bash
$ sudo -E ig image pull 192.168.1.16:5000/trace_exec:latest --insecure-registries="192.168.1.16:5000"
...

$ sudo -E ig run 192.168.1.16:5000/trace_exec:latest --insecure-registries="192.168.1.16:5000"
```
