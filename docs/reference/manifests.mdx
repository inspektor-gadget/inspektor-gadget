...
```bash
kubectl gadget run -f https://raw.githubusercontent.com/inspektor-gadget/inspektor-gadget/refs/heads/main/examples/instance-manifests/failed-dns-requests-all.yaml
```

Feel free to check out the [example manifests](https://github.com/inspektor-gadget/inspektor-gadget/tree/main/examples/instance-manifests) in the repository for more examples.
