...
import (
	...
	collectorprocess "github.com/kinvolk/inspektor-gadget/pkg/gadgets/collector-process"
...
func startController(node string, tracerManager *gadgettracermanager.GadgetTracerManager) {
	...
	gadgetRegistry := make(map[string]gadgets.Gadget)
	gadgetRegistry["biolatency"] = &biolatency.Gadget{}
	gadgetRegistry["collector-process"] = &collectorprocess.Gadget{}
	gadgetRegistry["network-policy-advisor"] = &networkpolicyadvisor.Gadget{}
