...
// Use upstream commit to be able to bump golang.org/x/*:
// https://github.com/cilium/ebpf/commit/36f6316fb169
replace github.com/cilium/ebpf => github.com/cilium/ebpf v0.0.0-20231109090417-36f6316fb169
