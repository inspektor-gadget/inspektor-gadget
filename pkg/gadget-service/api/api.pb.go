...
type GadgetEvent struct {
	...
	LostSamples   uint64 `protobuf:"varint,5,opt,name=lostSamples,proto3" json:"lostSamples,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GadgetEvent) GetLostSamples() uint64 {
	if x != nil {
...
type GadgetData struct {
	...
	LostSamples   uint64                 `protobuf:"varint,4,opt,name=lostSamples,proto3" json:"lostSamples,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GadgetData) GetLostSamples() uint64 {
	if x != nil {
		return x.LostSamples
	}
	return 0
...
func (x *GadgetDataArray) GetLostSamples() uint64 {
	if x != nil {
		return x.LostSamples
	}
	return 0
...
const file_api_api_proto_rawDesc = "" +
	...
	"\aversion\x18\x02 \x01(\rR\aversion\"\x93\x01\n" +
	"\vGadgetEvent\x12\x12\n" +
	"\x04type\x18\x01 \x01(\rR\x04type\x12\x10\n" +
	"\x03seq\x18\x02 \x01(\rR\x03seq\x12\x18\n" +
	"\apayload\x18\x03 \x01(\fR\apayload\x12\"\n" +
	"\fdataSourceID\x18\x04 \x01(\rR\fdataSourceID\x12 \n" +
	"\vlostSamples\x18\x05 \x01(\x04R\vlostSamples\"\x13\n" +
	...
	"\apayload\x18\x01 \x03(\fR\apayload\"z\n" +
	"\n" +
	"GadgetData\x12\x12\n" +
	"\x04node\x18\x01 \x01(\tR\x04node\x12\x10\n" +
	"\x03seq\x18\x02 \x01(\rR\x03seq\x12$\n" +
	"\x04data\x18\x03 \x01(\v2\x10.api.DataElementR\x04data\x12 \n" +
	"\vlostSamples\x18\x04 \x01(\x04R\vlostSamples\"\x89\x01\n" +
	"\x0fGadgetDataArray\x12\x12\n" +
	"\x04node\x18\x01 \x01(\tR\x04node\x12\x10\n" +
	"\x03seq\x18\x02 \x01(\rR\x03seq\x12.\n" +
	"\tdataArray\x18\x03 \x03(\v2\x10.api.DataElementR\tdataArray\x12 \n" +
	"\vlostSamples\x18\x04 \x01(\x04R\vlostSamples\"\xe3\x02\n" +
	"\x05Param\x12\x10\n" +
