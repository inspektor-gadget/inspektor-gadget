...
func (x *Param) GetAnnotations() map[string]string {
	if x != nil {
...
const file_api_api_proto_rawDesc = "" +
	...
	"\x04node\x18\x01 \x01(\tR\x04node\x12\x10\n" +
	"\x03seq\x18\x02 \x01(\rR\x03seq\x12.\n" +
	"\tdataArray\x18\x03 \x03(\v2\x10.api.DataElementR\tdataArray\"\xe2\x03\n" +
	"\x05Param\x12\x10\n" +
	...
	"\x0ealternativeKey\x18\f \x01(\tR\x0ealternativeKey\x12=\n" +
	"\vannotations\x18\r \x03(\v2\x1b.api.Param.AnnotationsEntryR\vannotations\x1a>\n" +
...
var file_api_api_proto_goTypes = []any{
	...
	nil,                                  // 29: api.Param.AnnotationsEntry
	nil,                                  // 30: api.GadgetInfo.AnnotationsEntry
	nil,                                  // 31: api.ExtraInfo.DataEntry
	nil,                                  // 32: api.DataSource.AnnotationsEntry
	nil,                                  // 33: api.Field.AnnotationsEntry
	nil,                                  // 34: api.GetGadgetInfoRequest.ParamValuesEntry
}
var file_api_api_proto_depIdxs = []int32{
	...
	29, // 6: api.Param.annotations:type_name -> api.Param.AnnotationsEntry
	16, // 7: api.GadgetInfo.dataSources:type_name -> api.DataSource
	30, // 8: api.GadgetInfo.annotations:type_name -> api.GadgetInfo.AnnotationsEntry
	12, // 9: api.GadgetInfo.params:type_name -> api.Param
	14, // 10: api.GadgetInfo.extraInfo:type_name -> api.ExtraInfo
	31, // 11: api.ExtraInfo.data:type_name -> api.ExtraInfo.DataEntry
	17, // 12: api.DataSource.fields:type_name -> api.Field
	32, // 13: api.DataSource.annotations:type_name -> api.DataSource.AnnotationsEntry
	0,  // 14: api.Field.kind:type_name -> api.Kind
	33, // 15: api.Field.annotations:type_name -> api.Field.AnnotationsEntry
	34, // 16: api.GetGadgetInfoRequest.paramValues:type_name -> api.GetGadgetInfoRequest.ParamValuesEntry
	13, // 17: api.GetGadgetInfoResponse.gadgetInfo:type_name -> api.GadgetInfo
	...
	24, // 21: api.GadgetInstance.state:type_name -> api.GadgetInstanceState
	1,  // 22: api.GadgetInstanceState.status:type_name -> api.GadgetInstanceStatus
	23, // 23: api.ListGadgetInstanceResponse.gadgetInstances:type_name -> api.GadgetInstance
	...
	8,  // 32: api.BuiltInGadgetManager.GetInfo:output_type -> api.InfoResponse
	19, // 33: api.GadgetManager.GetGadgetInfo:output_type -> api.GetGadgetInfoResponse
	4,  // 34: api.GadgetManager.RunGadget:output_type -> api.GadgetEvent
	21, // 35: api.GadgetInstanceManager.CreateGadgetInstance:output_type -> api.CreateGadgetInstanceResponse
	25, // 36: api.GadgetInstanceManager.ListGadgetInstances:output_type -> api.ListGadgetInstanceResponse
	23, // 37: api.GadgetInstanceManager.GetGadgetInstance:output_type -> api.GadgetInstance
	27, // 38: api.GadgetInstanceManager.RemoveGadgetInstance:output_type -> api.StatusResponse
