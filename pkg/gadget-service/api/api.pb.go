...
type Param struct {
	...
	AliasLong      string                 `protobuf:"bytes,12,opt,name=aliasLong,proto3" json:"aliasLong,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *Param) GetAliasLong() string {
	if x != nil {
		return x.AliasLong
	}
	return ""
...
const file_api_api_proto_rawDesc = "" +
	...
	"\x04node\x18\x01 \x01(\tR\x04node\x12\x10\n" +
	"\x03seq\x18\x02 \x01(\rR\x03seq\x12.\n" +
	"\tdataArray\x18\x03 \x03(\v2\x10.api.DataElementR\tdataArray\"\xd9\x02\n" +
	"\x05Param\x12\x10\n" +
	...
	"\x06prefix\x18\v \x01(\tR\x06prefix\x12\x1c\n" +
	"\taliasLong\x18\f \x01(\tR\taliasLong\"\xf3\x02\n" +
	"\n" +
	"GadgetInfo\x12\x12\n" +
