...
func gadgetInit() int {
	...
	assertNonZero(fieldAccessorSet(fieldHandle, dataHandle, uint32(api.Kind_Uint32), 1234), "fieldAccessorSet: ok")
	assertNonZero(fieldAccessorSet(fieldHandle, dataHandle, uint32(api.Kind_Uint64), 1234), "fieldAccessorSet: bad kind")
	assertNonZero(fieldAccessorSet(fieldHandle, dataHandle, 1005, 1234), "fieldAccessorSet: bad kind")
	assertNonZero(fieldAccessorSet(fieldHandle, fieldHandle, uint32(api.Kind_Uint32), 1234), "fieldAccessorSet: bad data handle")
	assertNonZero(fieldAccessorSet(dataHandle, dataHandle, uint32(api.Kind_Uint32), 1234), "fieldAccessorSet: bad field handle")

	assertEqual(uint32(fieldAccessorGet(fieldHandle, dataHandle, uint32(api.Kind_Uint32))), 1234, "fieldAccessorGet: ok")
	fieldAccessorGet(fieldHandle, dataHandle, 1005)
	fieldAccessorGet(fieldHandle, fieldHandle, uint32(api.Kind_Uint32))
	fieldAccessorGet(dataHandle, dataHandle, uint32(api.Kind_Uint32))
