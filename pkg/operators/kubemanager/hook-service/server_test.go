...
func TestHookServer(t *testing.T) {
	...
	testContainers := []*pb.ContainerDefinition{
		...
		},
		{
			...
			Podname:   "test-pod-3",
			Pid:       1003,
			LabelsSet: false, // Test without labels
		},
		{
	...
	// Test 2: Error cases for AddContainer
	t.Run("AddContainer_ErrorCases", func(t *testing.T) {
	...
	// Test 4: Error cases for RemoveContainer
	t.Run("RemoveContainer_ErrorCases", func(t *testing.T) {
		// Test empty container ID
	...
	// Test 5: Verify collection is empty after all removals
	t.Run("VerifyEmptyCollection", func(t *testing.T) {
