...
func New(cc *containercollection.ContainerCollection) *HookService {
	return &HookService{
		containerCollection: cc,
	}
}

func (s *HookService) AddContainer(ctx context.Context, containerDefinition *pb.ContainerDefinition) (*pb.AddContainerResponse, error) {
...
func (s *HookService) RemoveContainer(ctx context.Context, containerDefinition *pb.ContainerDefinition) (*pb.RemoveContainerResponse, error) {
	if containerDefinition.Id == "" {
		return nil, fmt.Errorf("container Id not set")
	}
