...
import (
	...
	processhelpers "github.com/inspektor-gadget/inspektor-gadget/pkg/operators/process/helpers"
...
func (p *processOperator) InstantiateDataOperator(gadgetCtx operators.GadgetContext, instanceParamValues api.ParamValues) (operators.DataOperatorInstance, error) {
	...
	if len(fields) == 0 {
		...
		enabledFields[fieldComm] = true
		enabledFields[fieldCPUUsage] = true
		enabledFields[fieldCPUUsageRelative] = true
		enabledFields[fieldMemoryRSS] = true
		enabledFields[fieldMemoryVirtual] = true
		enabledFields[fieldMemoryRelative] = true
	...
	if instance.enabledFields[fieldComm] {
	...
	if instance.enabledFields[fieldCPUUsageRelative] {
	...
	if instance.enabledFields[fieldMemoryRelative] {
	...
	if instance.enabledFields[fieldCPUUsage] || instance.enabledFields[fieldCPUUsageRelative] {
