...
func (o *otelProfilesOperatorInstance) PreStart(gadgetCtx operators.GadgetContext) error {
	...
	for _, ds := range gadgetCtx.GetDataSources() {
		...
		var valueFn func(data datasource.Data) (int64, error)
		...
		default:
			...
			continue
		case api.Kind_Int64:
			valueFn = func(data datasource.Data) (int64, error) {
				return valueField.Int64(data)
			}
		case api.Kind_Int32:
			valueFn = func(data datasource.Data) (int64, error) {
				v, err := valueField.Int32(data)
				return int64(v), err
			}
		case api.Kind_Int16:
			valueFn = func(data datasource.Data) (int64, error) {
				v, err := valueField.Int16(data)
				return int64(v), err
			}
		case api.Kind_Int8:
			valueFn = func(data datasource.Data) (int64, error) {
				v, err := valueField.Int8(data)
				return int64(v), err
			}
		case api.Kind_Uint64:
			valueFn = func(data datasource.Data) (int64, error) {
				v, err := valueField.Uint64(data)
				return int64(v), err
			}
		case api.Kind_Uint32:
			valueFn = func(data datasource.Data) (int64, error) {
				v, err := valueField.Uint32(data)
				return int64(v), err
			}
		case api.Kind_Uint16:
			valueFn = func(data datasource.Data) (int64, error) {
				v, err := valueField.Uint16(data)
				return int64(v), err
			}
		case api.Kind_Uint8:
			valueFn = func(data datasource.Data) (int64, error) {
				v, err := valueField.Uint8(data)
				return int64(v), err
			}
		}
