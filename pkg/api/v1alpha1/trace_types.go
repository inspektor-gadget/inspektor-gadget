...
type ContainerFilter struct {
	...
	// Podname selects events from containers with this name
...
type TraceSpec struct {
	...
	// RunMode is "Auto" to automatically start the trace a soon as the
	// resource is created, or "Manual" to be controlled by the annotation
	// "gadget.kinvolk.io/operation"
	RunMode string `json:"runMode,omitempty"`

	// Filter is to tell the gadget to filter events based on labels
