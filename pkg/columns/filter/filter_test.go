...
func TestFilters(t *testing.T) {
	...
	filterTests := []filterTest{
		...
		{filterString: "int:!~1", expectedCount: 4, expectError: false, description: "regular expression search on int, negated"},
		...
		{filterString: "int8:!~1", expectedCount: 4, expectError: false, description: "regular expression search on int8, negated"},
		...
		{filterString: "int16:!~1", expectedCount: 4, expectError: false, description: "regular expression search on int16, negated"},
		...
		{filterString: "int32:!~1", expectedCount: 4, expectError: false, description: "regular expression search on int32, negated"},
		...
		{filterString: "int64:!~1", expectedCount: 4, expectError: false, description: "regular expression search on int64, negated"},
		...
		{filterString: "float32:!~1", expectedCount: 4, expectError: false, description: "regular expression search on float32, negated"},
