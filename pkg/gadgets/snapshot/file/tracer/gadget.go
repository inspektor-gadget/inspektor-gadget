...
import (
	...
	"github.com/inspektor-gadget/inspektor-gadget/pkg/gadgets/snapshot/file/types"
...
func (g *GadgetDesc) Description() string {
	return "Gather information about open files"
}
...
func (g *GadgetDesc) SortByDefault() []string {
	return []string{
		"node", "namespace", "pod", "container", "pid", "fd",
	}
}
