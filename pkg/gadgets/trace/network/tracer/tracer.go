...
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -target bpfel -cc clang -cflags ${CFLAGS} -type event_t network ./bpf/network.c -- $CLANG_OS_FLAGS -I./bpf/ -I../../../../../include/
