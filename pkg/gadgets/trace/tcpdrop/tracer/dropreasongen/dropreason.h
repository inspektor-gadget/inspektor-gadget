// Downloaded from https://raw.githubusercontent.com/torvalds/linux/v6.2/include/net/dropreason.h
...
enum skb_drop_reason {
	...
	/**
	 * @SKB_DROP_REASON_PROTO_MEM: proto memory limitation, such as udp packet
