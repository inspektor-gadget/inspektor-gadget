...
func (f *Trace) Start(trace *gadgetv1alpha1.Trace) {
	if runtime.GOARCH != "amd64" {
		trace.Status.OperationError = fmt.Sprintf("This gadget is not supported on %s because it comes prebundled with eBPF object file compiled for amd64 (https://github.com/weaveworks/tcptracer-bpf/blob/d329ae7fb6fa90e4389075347f0754de2127336f/ebpf.mk#L18)", runtime.GOARCH)
		return
	}
