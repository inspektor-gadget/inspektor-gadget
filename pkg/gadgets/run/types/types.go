...
type RunGadgetDesc interface {
	...
	CustomParser(r *GadgetInfo) (parser.Parser, error)
	JSONConverter(r *GadgetInfo, p Printer) func(ev any)
	JSONPrettyConverter(r *GadgetInfo, p Printer) func(ev any)
	YAMLConverter(r *GadgetInfo, p Printer) func(ev any)
}
