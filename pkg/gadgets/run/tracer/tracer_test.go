...
func (t *testGadgetContext) Context() context.Context {
	return context.Background()
}

func (t *testGadgetContext) GadgetParams() *params.Params {
	return nil
}

func (t *testGadgetContext) Args() []string {
	return nil
}

func (t *testGadgetContext) Logger() logger.Logger {
	return &logger.StandardGenericLogger{}
}

func (t *testGadgetContext) Timeout() time.Duration {
	return 0
}
