...
type tcpconnectMapSpecs struct {
	...
	PrintEventsRingCounter *ebpf.MapSpec `ebpf:"print_events_ring_counter"`
...
type tcpconnectMaps struct {
	...
	PrintEventsRingCounter *ebpf.Map `ebpf:"print_events_ring_counter"`
