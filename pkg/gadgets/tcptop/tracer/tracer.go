...
//go:generate sh -c "GOOS=$(go env GOHOSTOS) GOARCH=$(go env GOHOSTARCH) go run github.com/cilium/ebpf/cmd/bpf2go -no-global-types -target bpfel -cc clang tcptop ./bpf/tcptop.bpf.c -- -I./bpf/ -I../../.. -target bpf -D__TARGET_ARCH_${BPF_ARCH}"
