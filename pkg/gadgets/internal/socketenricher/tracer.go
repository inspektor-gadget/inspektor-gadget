...
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -target $TARGET -cc clang socketenricher ./bpf/socket-enricher.bpf.c -- -I./bpf/ -I../../../../include/gadget/${TARGET} -I../../../../include

//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -target $TARGET -cc clang socketsiter ./bpf/sockets-iter.bpf.c -- -I./bpf/ -I../../../../include/gadget/${TARGET} -I../../../../include
