...
It has these top-level messages:
	...
	TracerSubscribeContainersRequest
	TracerSubscribeContainersResponse
	...
	DumpStateRequest
	Dump
	UpdateContainersRequest
	UpdateContainersResponse
*/
...
type TracerSubscribeContainersRequest struct {
	TracerId   string `protobuf:"bytes,1,opt,name=tracer_id,json=tracerId" json:"tracer_id,omitempty"`
	SocketFile string `protobuf:"bytes,2,opt,name=socket_file,json=socketFile" json:"socket_file,omitempty"`
}

func (m *TracerSubscribeContainersRequest) Reset()         { *m = TracerSubscribeContainersRequest{} }
func (m *TracerSubscribeContainersRequest) String() string { return proto.CompactTextString(m) }
func (*TracerSubscribeContainersRequest) ProtoMessage()    {}
func (*TracerSubscribeContainersRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor0, []int{3}
}

func (m *TracerSubscribeContainersRequest) GetTracerId() string {
	if m != nil {
		return m.TracerId
	}
	return ""
...
func (m *TracerSubscribeContainersRequest) GetSocketFile() string {
	if m != nil {
		return m.SocketFile
	}
	return ""
...
type TracerSubscribeContainersResponse struct {
	Debug string `protobuf:"bytes,1,opt,name=debug" json:"debug,omitempty"`
}

func (m *TracerSubscribeContainersResponse) Reset()         { *m = TracerSubscribeContainersResponse{} }
func (m *TracerSubscribeContainersResponse) String() string { return proto.CompactTextString(m) }
func (*TracerSubscribeContainersResponse) ProtoMessage()    {}
func (*TracerSubscribeContainersResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor0, []int{4}
}

func (m *TracerSubscribeContainersResponse) GetDebug() string {
	if m != nil {
		return m.Debug
	}
	return ""
...
type UpdateContainersRequest struct {
	Added   []*ContainerDefinition `protobuf:"bytes,1,rep,name=added" json:"added,omitempty"`
	Removed []*ContainerDefinition `protobuf:"bytes,2,rep,name=removed" json:"removed,omitempty"`
}
...
func (*UpdateContainersRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{12} }

func (m *UpdateContainersRequest) GetAdded() []*ContainerDefinition {
	if m != nil {
		return m.Added
	}
	return nil
...
func (m *UpdateContainersRequest) GetRemoved() []*ContainerDefinition {
	if m != nil {
		return m.Removed
	}
	return nil
...
func (*UpdateContainersResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{13} }

func (m *UpdateContainersResponse) GetDebug() string {
	if m != nil {
		return m.Debug
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*TracerSubscribeContainersRequest)(nil), "gadgettracermanager.TracerSubscribeContainersRequest")
	proto.RegisterType((*TracerSubscribeContainersResponse)(nil), "gadgettracermanager.TracerSubscribeContainersResponse")
	...
	proto.RegisterType((*UpdateContainersRequest)(nil), "gadgettracermanager.UpdateContainersRequest")
	proto.RegisterType((*UpdateContainersResponse)(nil), "gadgettracermanager.UpdateContainersResponse")
}
...
type GadgetTracerManagerClient interface {
	...
	TracerSubscribeContainers(ctx context.Context, in *TracerSubscribeContainersRequest, opts ...grpc.CallOption) (GadgetTracerManager_TracerSubscribeContainersClient, error)
...
func (c *gadgetTracerManagerClient) TracerSubscribeContainers(ctx context.Context, in *TracerSubscribeContainersRequest, opts ...grpc.CallOption) (GadgetTracerManager_TracerSubscribeContainersClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_GadgetTracerManager_serviceDesc.Streams[0], c.cc, "/gadgettracermanager.GadgetTracerManager/TracerSubscribeContainers", opts...)
	if err != nil {
		return nil, err
	}
	x := &gadgetTracerManagerTracerSubscribeContainersClient{stream}
...
type GadgetTracerManager_TracerSubscribeContainersClient interface {
	Recv() (*TracerSubscribeContainersResponse, error)
	grpc.ClientStream
}

type gadgetTracerManagerTracerSubscribeContainersClient struct {
	grpc.ClientStream
}

func (x *gadgetTracerManagerTracerSubscribeContainersClient) Recv() (*TracerSubscribeContainersResponse, error) {
	m := new(TracerSubscribeContainersResponse)
...
type GadgetTracerManagerServer interface {
	...
	TracerSubscribeContainers(*TracerSubscribeContainersRequest, GadgetTracerManager_TracerSubscribeContainersServer) error
...
func _GadgetTracerManager_TracerSubscribeContainers_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(TracerSubscribeContainersRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(GadgetTracerManagerServer).TracerSubscribeContainers(m, &gadgetTracerManagerTracerSubscribeContainersServer{stream})
}

type GadgetTracerManager_TracerSubscribeContainersServer interface {
	Send(*TracerSubscribeContainersResponse) error
	grpc.ServerStream
}

type gadgetTracerManagerTracerSubscribeContainersServer struct {
	grpc.ServerStream
}

func (x *gadgetTracerManagerTracerSubscribeContainersServer) Send(m *TracerSubscribeContainersResponse) error {
...
var _GadgetTracerManager_serviceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		{
			StreamName:    "TracerSubscribeContainers",
			Handler:       _GadgetTracerManager_TracerSubscribeContainers_Handler,
			ServerStreams: true,
		},
	},
...
type TracerClient interface {
	UpdateContainers(ctx context.Context, in *UpdateContainersRequest, opts ...grpc.CallOption) (*UpdateContainersResponse, error)
}
...
func (c *tracerClient) UpdateContainers(ctx context.Context, in *UpdateContainersRequest, opts ...grpc.CallOption) (*UpdateContainersResponse, error) {
	out := new(UpdateContainersResponse)
	err := grpc.Invoke(ctx, "/gadgettracermanager.Tracer/UpdateContainers", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Tracer_UpdateContainers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateContainersRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TracerServer).UpdateContainers(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gadgettracermanager.Tracer/UpdateContainers",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TracerServer).UpdateContainers(ctx, req.(*UpdateContainersRequest))
	}
	return interceptor(ctx, in, info, handler)
}

var _Tracer_serviceDesc = grpc.ServiceDesc{
	ServiceName: "gadgettracermanager.Tracer",
	HandlerType: (*TracerServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "UpdateContainers",
			Handler:    _Tracer_UpdateContainers_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "gadgettracermanager.proto",
...
var fileDescriptor0 = []byte{
	...
	,
}
