...
func init() {
	...
	deployCmd.PersistentFlags().MarkDeprecated("hook-mode", "This flag is deprecated and will be removed in a future release. Use --set-daemon-config=hook-mode=<auto|crio|podinformer|nri|fanotify+ebpf> instead")
	...
	deployCmd.PersistentFlags().MarkDeprecated("fallback-podinformer", "This flag is deprecated and will be removed in a future release. Use --set-daemon-config=fallback-pod-informer=<true|false> instead")
	deployCmd.PersistentFlags().BoolVarP(
		&printOnly,
		"print-only", "",
		false,
	...
	deployCmd.PersistentFlags().MarkDeprecated("events-buffer-length", "This flag is deprecated and will be removed in a future release. Use --set-daemon-config=events-buffer-length=<value> instead")
	deployCmd.PersistentFlags().StringVarP(
		&daemonLogLevel,
	...
	deployCmd.PersistentFlags().MarkDeprecated("verify-gadgets", "This flag is deprecated and will be removed in a future release. Use --set-daemon-config=operator.oci.verify-image=<true|false> instead")
	...
	deployCmd.PersistentFlags().MarkDeprecated("gadgets-public-keys", "This flag is deprecated and will be removed in a future release. Use --daemon-config instead")
	...
	deployCmd.PersistentFlags().MarkDeprecated("allowed-gadgets", "This flag is deprecated and will be removed in a future release. Use --daemon-config instead")
	deployCmd.PersistentFlags().StringSliceVar(
		&insecureRegistries,
		"insecure-registries",
		[]string{},
	...
	deployCmd.PersistentFlags().MarkDeprecated("insecure-registries", "This flag is deprecated and will be removed in a future release. Use --daemon-config instead")
	deployCmd.PersistentFlags().BoolVar(
		&disallowGadgetsPull,
		"disallow-gadgets-pulling", false, "Disallow pulling gadgets from registries")
	deployCmd.PersistentFlags().MarkDeprecated("disallow-gadgets-pulling", "This flag is deprecated and will be removed in a future release. Use --set-daemon-config=operator.oci.disallow-pulling=<true|false> instead")
	deployCmd.PersistentFlags().BoolVar(
		&otelMetricsListen,
		"otel-metrics-listen", false, "Enable OpenTelemetry metrics listener (Prometheus compatible) endpoint")
	deployCmd.PersistentFlags().MarkDeprecated("otel-metrics-listen", "This flag is deprecated and will be removed in a future release. Use --set-daemon-config=operator.otel-metrics.otel-metrics-listen=<true|false> instead")
	deployCmd.PersistentFlags().StringVar(
	...
	deployCmd.PersistentFlags().MarkDeprecated("otel-metrics-listen-address", "This flag is deprecated and will be removed in a future release. Use --set-daemon-config=operator.otel-metrics.otel-metrics-listen-address=<address> instead")
	deployCmd.PersistentFlags().StringSliceVar(
		&setDaemonConfig,
		"set-daemon-config", []string{}, "Set a key-value pair in the daemon ConfigMap. The format is key=value. This flag can be used multiple times to set multiple values. Only recommended for primitive values (string, int, bool). For complex values, use --daemon-config flag with a YAML file.")
	deployCmd.PersistentFlags().StringVar(
		&daemonConfig,
		"daemon-config", "", "Path to a config file to override the daemon ConfigMap values. The file should be in YAML format")
...
func runDeploy(cmd *cobra.Command, args []string) error {
	...
	for _, object := range objects {
		...
		if cm, isCm := object.(*v1.ConfigMap); isCm {
			...
			err = applyConfigToConfgMap(cm, daemonConfig, cmd.PersistentFlags())
			if err != nil {
