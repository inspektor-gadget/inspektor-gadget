...
func NewTcpconnectParser(outputConfig *commonutils.OutputConfig) commontrace.TraceParser[types.Event] {
...
func (p *TcpconnectParser) TransformToColumns(event *types.Event) string {
