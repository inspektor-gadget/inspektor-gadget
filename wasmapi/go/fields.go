...
func fieldAccessorSet(acc uint32, data uint32, kind uint32, value uint64) uint32
...
func (f Field) SetInt8(data Data, value int8) error {
	ret := fieldAccessorSet(uint32(f), uint32(data), uint32(Kind_Int8), uint64(value))
	if ret != 0 {
		return errSetField
	}
	return nil
...
func (f Field) SetInt16(data Data, value int16) error {
	ret := fieldAccessorSet(uint32(f), uint32(data), uint32(Kind_Int16), uint64(value))
	if ret != 0 {
		return errSetField
	}
	return nil
...
func (f Field) SetInt32(data Data, value int32) error {
	ret := fieldAccessorSet(uint32(f), uint32(data), uint32(Kind_Int32), uint64(value))
	if ret != 0 {
		return errSetField
	}
	return nil
...
func (f Field) SetInt64(data Data, value int64) error {
	ret := fieldAccessorSet(uint32(f), uint32(data), uint32(Kind_Int64), uint64(value))
	if ret != 0 {
		return errSetField
	}
	return nil
...
func (f Field) SetUint8(data Data, value uint8) error {
	ret := fieldAccessorSet(uint32(f), uint32(data), uint32(Kind_Uint8), uint64(value))
	if ret != 0 {
		return errSetField
	}
	return nil
...
func (f Field) SetUint16(data Data, value uint16) error {
	ret := fieldAccessorSet(uint32(f), uint32(data), uint32(Kind_Uint16), uint64(value))
	if ret != 0 {
		return errSetField
	}
	return nil
...
func (f Field) SetUint32(data Data, value uint32) error {
	ret := fieldAccessorSet(uint32(f), uint32(data), uint32(Kind_Uint32), uint64(value))
	if ret != 0 {
		return errSetField
	}
	return nil
...
func (f Field) SetUint64(data Data, value uint64) error {
	ret := fieldAccessorSet(uint32(f), uint32(data), uint32(Kind_Uint64), uint64(value))
	if ret != 0 {
		return errSetField
	}
	return nil
...
func (f Field) SetFloat32(data Data, value float32) error {
	ret := fieldAccessorSet(uint32(f), uint32(data), uint32(Kind_Float32), uint64(math.Float32bits(value)))
	if ret != 0 {
		return errSetField
	}
	return nil
...
func (f Field) SetFloat64(data Data, value float64) error {
	ret := fieldAccessorSet(uint32(f), uint32(data), uint32(Kind_Float64), uint64(math.Float64bits(value)))
	if ret != 0 {
		return errSetField
	}
	return nil
...
func (f Field) SetString(data Data, str string) error {
	ret := fieldAccessorSet(uint32(f), uint32(data), uint32(Kind_String), uint64(stringToBufPtr(str)))
...
func (f Field) SetBytes(data Data, buf []byte) error {
	ret := fieldAccessorSet(uint32(f), uint32(data), uint32(Kind_Bytes), uint64(bytesToBufPtr(buf)))
