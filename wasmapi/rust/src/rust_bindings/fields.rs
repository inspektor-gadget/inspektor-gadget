...
use crate::rust_bindings::helpers::{bytes_to_buf_ptr, from_c_string, string_to_buf_ptr}; //relative paths may hinder in testing.
use std::any::Any;
...
impl Field {
    ...
    pub fn get_data(&self, data: Data, field_kind: FieldKind) -> Result<Box<dyn Any + Send>> {
        match field_kind {
            FieldKind::Bool => {
