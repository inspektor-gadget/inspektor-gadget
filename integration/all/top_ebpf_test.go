...
func TestTopEbpf(t *testing.T) {
	...
	t.Run("Timeout", func(t *testing.T) {
		...
		cmd := fmt.Sprintf("%s top ebpf -o json -m 999 --timeout %d %s", DefaultTestComponent, topTimeoutInSeconds, extraArgs)
	...
	t.Run("Interval=Timeout", func(t *testing.T) {
		...
		cmd := fmt.Sprintf("%s top ebpf -o json -m 999 --timeout %d --interval %d %s", DefaultTestComponent, topTimeoutInSeconds, topTimeoutInSeconds, extraArgs)
